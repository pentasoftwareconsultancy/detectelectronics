    ...
    <div className="w-full bg-gradient-to-b from-gray-50 to-gray-100 py-16 antialiased">
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/assets/AboutElectro.jpg)` }}
        >
        ...
        <div className="bg-white p-6 sm:p-10 rounded-3xl shadow-lg text-gray-800 leading-relaxed">
          {[ 
            `Detect Electronics Systems (I) Private Limited, a sister company of Detect Electronics System with 25+ years of experience, marks its presence in the market by providing customer-satisfactory service. DESIPL consists of well-trained and skilled manpower in OFC, Civil Engineering, Telecommunications, Electrical, and Contract Management fields.`,
