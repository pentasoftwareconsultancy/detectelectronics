...
const HomeCard = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="grid lg:grid-cols-2 gap-16 my-24 max-w-7xl px-6">
        {/* Career Opportunity */}
        <motion.div
          ...
          className="group"
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 group-hover:border-green-200">
        ...
        <motion.div
          ...
          className="group"
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 group-hover:border-yellow-200">
            <div className="flex items-center gap-4 mb-6">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-lg">
              ...
              opportunities to participate in our sourcing selection processes.
              All vendors may register online to work on exciting projects and
              grow with us.
            </p>
            <motion.button
              variants={buttonVariants}
