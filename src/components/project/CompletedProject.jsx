...
export default function CompletedProject() {
  const projects = [
    ...
    },
    {
      ...
      domain: "telecom",
      details: "TOWERS (GBT & RTT) – 1800 NO",
    ...
    },
    {
      ...
      domain: "telecom",
      details: "ELECTRICAL (HT/LT Work) – 1200 SITES",
    ...
    },
    {
      id: 5,
      title: "O & M Work",
      description: "Operations and maintenance across multiple telecom sites.",
      domain: "telecom",
      details: "O & M Work – 1000+ sites",
      features: ["Maintenance efficiency", "Downtime reduction"],
      tech: ["om"],
      status: "Ongoing",
    },
    {
