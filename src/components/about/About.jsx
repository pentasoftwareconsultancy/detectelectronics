...
const About = () => {
    ...
    return (
        <div className="relative min-h-screen py-20 px-6 md:px-12 overflow-hidden">
            ...
            >
                <h1 className="text-5xl md:text-6xl font-extrabold text-[#2384c5] mb-4">
                    About Us
                </h1>
                ...
                {hosting.map((card, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                className={`relative w-full h-full duration-700 transform-style-3d ${flippedCard === i ? "rotate-y-180" : ""
                                    }`}
                            >
                                {/* Front Side */}
                                <div
