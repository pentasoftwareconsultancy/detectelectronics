    ...
    <main className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-2 gap-12 max-w-7xl w-full">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-lg border border-blue-100">
          <h2 className="text-3xl font-bold mb-6 text-[#1E3A8A] text-center">Send us a message</h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="relative">
              <FiUser className="absolute top-1/2 left-3 -translate-y-1/2 text-[#6B7280]" size={20} />
              <input
                type="text"
                name="name"
            ...
            <div className="relative">
              <FiMail className="absolute top-1/2 left-3 -translate-y-1/2 text-[#6B7280]" size={20} />
              <input
                type="email"
                name="email"
            ...
            <div className="relative">
              <FiMessageCircle className="absolute top-3 left-3 text-[#6B7280]" size={20} />
              <textarea
                name="message"
        ...
        <div className="bg-white p-10 rounded-3xl shadow-lg border border-blue-100 flex flex-col justify-center items-center space-y-6">
          <h2 className="text-3xl font-bold mb-4 text-[#1E3A8A] text-center">Contact Info</h2>
